...
import de.integrata.hkw08.global.Brennbar;
 ...
 * @version 2.6.107	krg Geänderte Reihenfolge MVC nach GUI: extends Observable
 * 			notifyObserver() in setIsttemperatur()
 */
public class Ofen extends Observable {
  ...
  public void setIstTemperatur(int i) {
  	this.istTemperatur = i;
  	this.setChanged();
  	this.notifyObservers(new Integer(this.getIstTemperatur()));
  }
