package de.integrata.hkw08.ofen;

import de.integrata.hkw08.util.*;
...
public class OfenControllerImpl {
   ...
   * ist auch nur deshalb hier so implementiert.
	...
	protected Map<String, String> leseBrennelementeListe() {
		...
		hm.put("Buchenholz", "de.integrata.hkw08.brennelemente.Holz; Buche");
		hm.put("Fichtenholzholz", "de.integrata.hkw08.brennelemente.Holz; Fichte");
		hm.put("Papier", "de.integrata.hkw08.brennelemente.Papier; Zeitung");
		hm.put("Sofa", "de.integrata.hkw08.moebel.Sofa; Stoff");
		hm.put("Sofa2", "de.integrata.hkw08.moebel.Sofa");	//nicht erzeugbar
		hm.put("Dose1", "de.integrata.hkw08.brennelemente.Dose; Aluminium");
		hm.put("Dose2", "de.integrata.hkw08.brennelemente.Dose; Zinn");
		hm.put("Schrank", "de.integrata.hkw08.moebel.MetallSchrank; Blech");
		return hm;
	}
