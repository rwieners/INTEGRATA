package de.integrata.hkw04.ofen;

import de.integrata.hkw04.global.Brennbar;
import de.integrata.hkw04.util.*;
...
public class OfenControllerImpl {
	...
	public OfenControllerImpl() {
		...
		System.out.println("--- Init abgeschlossen ---");
	}
	...
	public void startSorted() {
		...
		for (int i = 0; i < objListe.size(); i++) {
			...
			if (o instanceof Brennbar) {
				...
				System.err.println(o + " ist nicht Brennbar!");
			}
		}
	...
	public String[] getBeKeys() {
		...
		Set<String> keyList = beListe.keySet();
		List<String> beNamen = new ArrayList<String>(keyList);
		Collections.sort(beNamen);;
