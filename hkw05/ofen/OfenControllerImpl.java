...
import de.integrata.hkw05.util.*;
...
public class OfenControllerImpl {
	 ...
	 * Brennelemnet erzeugt. Die Brennelemente werden über eine Factory dynamisch
	 * erzeugt. Die Brennelemnteerzeugung ist in die Ofen-Steuerung ausgelagert,
	 * es wird nur eine Kennung (== Integernummer) des gewünschten Brennelemnts
	 * übermittelt.
	 */
	...
	public String[] getBeKeys() {
		...
		List<String> beNames= new ArrayList<String>(keyList);
		Collections.sort(beNames);
		System.out.println("beNames=" + beNames);
		String[] nameArray = new String[beSize];
		nameArray = (String[]) beNames.toArray(nameArray);
	 ...
	 * HashMap. Das Beladen des Ofens erfolgt aus dieser HashMap. Die Keys der Map
	 * enthalten die Brennelementekennung (String). Die Values enthalten einen
	 * String mit den Teilen:<br>
	 * <ul>
	...
	protected Map<String, String> leseBrennelementeListe() {
		...
		hm.put("Buchenholz", "de.integrata.hkw.brennelemente.Holz; Buche");
		hm.put("Fichtenholzholz", "de.integrata.hkw.brennelemente.Holz; Fichte");
		hm.put("Papier", "de.integrata.hkw.brennelemente.Papier; Zeitung");
		hm.put("Sofa", "de.integrata.hkw.moebel.Sofa; Stoff");
		hm.put("Sofa2", "de.integrata.hkw.moebel.Sofa"); // nicht erzeugbar
		hm.put("Dose1", "de.integrata.hkw.brennelemente.Dose; Aluminium");
		hm.put("Dose2", "de.integrata.hkw.brennelemente.Dose; Zinn");
		hm.put("Schrank", "de.integrata.hkw.moebel.MetallSchrank; Blech");
		return hm;
	}

	/**
	 * Verbrennt ein Brennelementobjekt, das über den Schlüssel-Parameter der
	 * Brennelementeliste bestimmt wird. Das Objekt wird dynamisch mittels Factory
	 * erzeugt.
	 * 
	 * @param beKey
